...
public class BasePage {
    ...
    public void clickElement(By locator, long timeout) {
    ...
    public void dragAndDrop(WebElement dragElm, WebElement dropElm) {
        WebDriverWait wait = new WebDriverWait(world.webDriverFactory.getDriver(), CommonData.DEFAULT_TIMEOUT);
    ...
    public void setValue(By locator, String value, long timeout) {
    ...
    public void scrollIntoView(By locator, String option) {
        WebElement elm = waitElementToBeExist(locator);
        JavascriptExecutor je = (JavascriptExecutor) world.webDriverFactory.getDriver();
    ...
    public List<WebElement> getListElements(By selector) {
