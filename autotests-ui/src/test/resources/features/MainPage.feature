...
Feature: Home Page
  ...
  @hp_004 @profitable_shopping
    Scenario: profitable shopping
      When the user click on profitable shopping
      Then the user should see Download the app now button

  @hp_005 @verify_my_account
  ...
  @hp_006 @Verify_my_order_in_account
  ...
  @hp_007 @verify_my_notifications_in_my_account_ERROR
  ...
  @hp_008 @My_Notification_in_my_account
  ...
  @hp_009 @Easy_exchange_and_return_in_my_account
  ...
  @hp_10 @comment_product_in_my_account
  ...
  @hp_11 @Return_goods_in_my_account
